...
CREATE OR REPLACE FUNCTION add_online_retrofitting_statistics(varchar(200)) RETURNS integer
AS '$libdir/freddy', 'add_online_retrofitting_statistics'
LANGUAGE C IMMUTABLE STRICT;

CREATE OR REPLACE FUNCTION parseDeltaGroups(varchar(200)) RETURNS integer
